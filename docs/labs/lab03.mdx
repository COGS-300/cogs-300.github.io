...
You will also need to create and maintain a GitHub repo (below) for your code and/or a shared drive for your robot documentation. You can use other platforms as needed, but the robot code needs to be in a well-maintained GitHib repo that includes usage instructions.
...
### 3. Add your team to the GitHub repository


### 4. Driving forwards and backwards
