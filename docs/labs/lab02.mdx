...
Since we have not taught you how to use the motor drivers and servos that you will eventually use for your robots, any actuation that your device does will need to be acted out using the [wizard of oz](https://www.nngroup.com/articles/wizard-of-oz/) method. Draw a workflow for what *would* happen if you did indeed have a working motor, and use your hands to make the thing move instead. You can use this for any components or computational processes that you haven't learned yet.
...
Your final product will be a looks-like-works-like prototype. That means it needs to be a prototype that really works with real electronic components attached to your interface parts that really are wired into your Arduino. If you can achieve looks-works-feels, great! But actuation will have to be human-driven and wizard-of-oz.


### 4. Wizard of Oz Workflow (start in lab, finish for homework)
...
Make a wizard-of-oz workflow for your prototype. Do actually write it down so that you can remember and repeat your prototype actions for your TA. It should be clearly written enough that your TA could read through it and basically understand how your prototype works without you being there.


### 5. Looks-like-Works-Like Prototype and Video (homework)
...
- A coherent narrative and drawn WoZ workflow

A large portion of the interface must really, truly work with an Arduino interactive loop. You may use a Processing.org sketch to interact with your Arduino, but you are not required to.
