...
**Lesson**. Robot system hierarchies.
**Activity**. [Wire a servo](https://www.tinkercad.com/things/hcDQxz3cDFx-servo?sharecode=uJvyGNifyDRr85e7w36UiAWuWBPoZYiwyoyQtH2kXko).
<!-- - **Activity**. Optical Encoders. -->
<!-- - **Activity**. [Optical Encoders](/teaching/activities/encoders). -->
- **Activity**. How does a Servo work?
<!-- - **Activity**. [How does a Servo work](/teaching/activities/servo) -->
