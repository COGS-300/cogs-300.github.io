...
- **In-class design challenge**. [Using your body to estimate things](/teaching/activities/estimation).
- **Module design challenge**. [Module 1: Estimate a Building](/sketchbook/01-estimate-a-building.md)
- **Activity**. [Electricity 101](/teaching/activities/electricity)
- **Resource**. [TinkerCAD](https://www.tinkercad.com/joinclass/LYAA2XQHV)
...
- **Resource**. [Arduino](https://docs.arduino.cc/software/ide/)
- **Resource**. [Processing](http://processing.org/download)
