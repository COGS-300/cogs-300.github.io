...
The [Open Circuits](https://opencircuitsbook.com/) book is one of the best sources for getting a close-up look at cutaway circuits like the ones I've shown you in class. It is not a required textbook, but if you're interested in learning about circuits, it's a must-have.

---
## Summary of the Day

- **Activity**. [Digital Signals](/docs/concepts/teaching/activities/activity-01-signals.md).
- **Lecture**. [Neuron Logic](/docs/concepts/teaching/lessons/lesson-01-neuron-logic.md).
