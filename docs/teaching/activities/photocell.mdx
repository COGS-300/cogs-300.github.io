...
You can use a [potentiometer as a model](/docs/teaching/activities/analog-signals) for your photocell circuit.
...
---
## Activity
This activity is meant to go along with the previous [analog signals](/docs/teaching/activities/analog-signals) activity. Most of the conceptual background is there.
