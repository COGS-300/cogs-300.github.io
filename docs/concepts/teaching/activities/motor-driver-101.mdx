...
### Build the Circuit
Build **one side** of the [L298N circuit from this tutorial](https://projecthub.arduino.cc/lakshyajhalani56/l298n-motor-driver-arduino-motors-motor-driver-l298n-7e1b3b). Getting familiar with the meaning of the pinouts will be helpful for when you encounter this in lab. Use the following pins for your Arduino:
