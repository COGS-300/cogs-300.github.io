...
You can use a [potentiometer as a model](/docs/concepts/teaching/activities/02-analog-signals) for your photocell circuit.
...
---
## Activity
This activity is meant to go along with the previous [analog signals](/docs/concepts/teaching/activities/02-analog-signals) activity. Most of the conceptual background is there.
