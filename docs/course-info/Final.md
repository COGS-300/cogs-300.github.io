...
Keeps a car at a specific speed except when another car is detected in front.
If there is a car detected in front, maintains a specific distance from that car, no matter what the speed.
